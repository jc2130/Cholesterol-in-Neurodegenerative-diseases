...
#Lewy body pathology
k_t_SNCA_aggr=1e-7
k_t_SNCA_fibril=6e-5
k_t_IRE=3.276625981873e-4
k_t_SNCA_degr=1.510574018e-4
k_t_SNCA_degr_VPS35 = 1.1329305e-4
p_SNCA_act_homeostasis = 4.4e8
LB_threshold=10
...
k_t_chol_trans_LE_mito = 2.36 * 10 ** (-6) # s^-1 # NPCD changed exponent to -9
homeo_p_PERK_ER = 1e6
k_t_chol_trans_LE_PM = 0.002406761 # s^-1
k_t_chol_trans_ER_PM = 1.725 * 10 ** (-3) # s^-1
k_t_chol_trans_PM_ER = 1.56 * 10 ** (-6) # s^-1
k_t_chol_trans_ER_mito = 1.1713 * 10 ** (-4) # s^-1 # NPCD changed exponent to -7
...
k_t_Ca_cyto_LE = 0.5*10**(-2)#0.20698
k_t_ERstress_Ca_cyto_induc = 1
...
k_t_ROS_gener_Ab = 8.4e-1 # s^-1  maximum is 7e3 (from 8.4e-1)
k_t_ROS_metab_LB=k_t_ROS_metab*0.5
k_t_ROS_metab_DJ1=1/2
cas3_homeostasis = 22500
k_t_TRADD_actv = 1e1 # tuned from original value due to simplications from NPCD vs integrated apoptosis network

# AD therapeutics
ther_bsec_cleav_inhib = 0.03 
ther_GSK3b_inhib = 0.25 
ther_chol_lower_LDLR = 0.7 

'''
# Energy metabolism from PD
#k_t_krebs = (1.63*10**(-7))*2968656.262/3e7
#k_t_ETC = 2.48*10**(-5)*2968656.262/3e7
