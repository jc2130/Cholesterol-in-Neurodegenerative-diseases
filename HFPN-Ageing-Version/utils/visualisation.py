...
sys.path.insert(0, cwd[:(cwd.index(root_folder)+len(root_folder))] + os.sep + "HFPN-Stochastic-Version" + os.sep + "utils" + os.sep)
from stochastic_hfpn import HFPN 

cwd = os.getcwd()
root_folder = os.sep + "Cholesterol-in-Neurodegenerative-diseases"
